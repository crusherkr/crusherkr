...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        back_btn = QAction(QIcon(os.path.join('icons', 'cil-arrow-circle-left.png')), "이전 페이지로", self)
        ...
        next_btn = QAction(QIcon(os.path.join('icons', 'cil-arrow-circle-right.png')), "앞으러", self)
        ...
        reload_btn = QAction(QIcon(os.path.join('icons', 'cil-reload.png')), "새로고침", self)
        ...
        # HOME PAGE BUTTON
        home_btn = QAction(QIcon(os.path.join('icons', 'cil-home.png')), "메인페이지", self)
        ...
        stop_btn = QAction(QIcon(os.path.join('icons', 'cil-media-stop.png')), "멈추기", self)
        ...
        new_tab_action = QAction(QIcon(os.path.join('icons', 'cil-library-add.png')), "새 창 열기", self)
        new_tab_action.setStatusTip("새 창을 엽니다.")
        file_menu.addAction(new_tab_action)
        # ADD NEW TAB
        new_tab_action.triggered.connect(lambda _: self.add_new_tab())

        # SET WINDOW TITTLE AND ICON
        self.setWindowTitle("크라우저 Crowser")
        ...
        # url = http://crusherbrowser.kro.kr,
        # label = Homepage
        self.add_new_tab(QUrl('http://crusherbrowser.kro.kr'), 'Homepage')
    ...
    def navigate_home(self):
        self.tabs.currentWidget().setUrl(QUrl("http://crusherbrowser.kro.kr"))

        # download



    QtCore.QCoreApplication.setOrganizationName("crusherbrowser")
    QtCore.QCoreApplication.setOrganizationDomain("http://crusherbrowser.kro.kr")
    QtCore.QCoreApplication.setApplicationName("CrusehrBrowser")
...
# APPLICATION NAME
app.setApplicationName("crowser")
# APPLICATION COMPANY NAME
app.setOrganizationName("crusherSW")
# APPLICATION COMPANY ORGANISATION
app.setOrganizationDomain("crusherbrowser.kro.kr")
